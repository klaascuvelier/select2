...
(function ($, undefined) {
    ...
    var KEY, AbstractSelect2, SingleSelect2, MultiSelect2, FancyMultipleSelect2, nextUid, sizer,
    ...
    function ajax(options) {
        var timeout         = void 0,   // current scheduled but not yet executed request
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        updateResults: function (initial) {
            ...
            opts.query({
                ...
                } else if (searchVal.length > 0 && opts.allowAddNewItem) {
        ...
        initContainerWidth: function () {
            function resolveContainerWidth() {
                ...
                if (options.width === "off") {
                    return null;
                } else if (options.width === "element"){
                    return options.element.outerWidth(false) === 0 ? 'auto' : options.element.outerWidth(false) + 'px';
                } else if (options.width === "copy" || options.width === "resolve") {
                    // check if there is inline style on the element that contains width
                    style = options.element.attr('style');
                    if (style !== undefined) {
                        attrs = style.split(';');
                    ...
                    if (options.width === "resolve") {
                        // next check if css('width') can resolve a width that is percent based, this is sometimes possible
                        // when attached to input type=hidden or elements hidden via css
                        style = options.element.css('width');
                    ...
                    return null;
                } else if ($.isFunction(options.width)) {
    ...
    FancyMultipleSelect2 = clazz(AbstractSelect2, {
        ...
        unselect: function (selected) {
            ...
            if (selected.length === 0) {
                throw "Invalid argument: " + selected + ". Must be .select2-result";
            }
    ...
    $.fn.select2 = function () {
        ...
        this.each(function () {
            if (args.length === 0 || typeof(args[0]) === "object") {
                ...
                if (multiple && opts.useDropdown) {
                    select2 = new FancyMultipleSelect2();
                } else if (multiple) {
                    select2 = new MultiSelect2();
                } else {
                    select2 = new SingleSelect2();
                }
                select2.init(opts);
    ...
    window.Select2 = {
        query: {
            ...
            "multi": MultiSelect2,
            "fancy-multi": FancyMultipleSelect2
        }
    };
